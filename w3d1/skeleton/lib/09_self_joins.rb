...
def start_at_craiglockhart
  ...
  execute(<<-SQL)
    ...
    FROM
      stops AS start_stop
    JOIN routes AS start_stop ON start_route.stop_id = start_stop.id
    JOIN routes AS s_to_t_route ON s_to_t_route.company = start_route.company
    AND s_to_t_route.num = start_route.num
